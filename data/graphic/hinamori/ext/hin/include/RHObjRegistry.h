...
class HinObjRegistry {
  ...
  /**
  * The Hinamori_Objects hash table basically maps C++ objects to Ruby instances.
  * Each key in the table is a pointer to a C++ object we've seen before, and
  * the corresponding value is an HinamoriObjDesc struct (see below) that tells
  * us which Ruby instance corresponds to that C++ object.
  */

  st_table * Hinamori_Objects;

  /**
  * Each value in the Hinamori_Objects hash table is an instance of this
...
public:
  ...
  * registers this C++ object & Ruby instance pair in our Hinamori_Objects
