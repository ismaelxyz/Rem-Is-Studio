...
<b>This is the RDoc-generated API documentation for Hinamori version 1.6.</b>
...
implemented in C++ code (since Hinamori is itself a C++ extension to Ruby).
...
* In lieu of (or in addition) to short code examples embedded in the API
  documentation, links to examples that are shipped with Hinamori might be good.
----
